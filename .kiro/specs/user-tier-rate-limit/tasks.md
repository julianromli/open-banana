...
- [ ] 1. Create tier configuration and types
  - [x] 1.1 Add UserTier type and TierConfig interface to route.ts
  ...
  - [x] 1.2 Create getUserTier function
...
- [ ] 2. Update rate limiting logic
  - [x] 2.1 Modify checkRateLimit function signature
  ...
  - [x] 2.2 Update POST handler to use tier-aware rate limiting
...
- [ ] 4. Add property-based tests
  ...
  - [x] 4.5 Write property test for response headers
